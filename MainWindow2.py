...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.musicBtn = QPushButton(QIcon("src/music.png"), "", self.bottomBar)
        ...
        self.notesBtn = QPushButton(QIcon("src/notes.png"), "", self.bottomBar)
        self.notesBtn.setGeometry(QRect((width-dim)/2+dim, 0, dim, dim))
        self.notesBtn.setIconSize(QSize(dim,dim))
        ...
        self.settingsBtn = QPushButton(QIcon("src/settings.png"), "", self.bottomBar)
    ...
    def onClickNotes(self):
        ...
        self.notesBtn.setIcon(QIcon("src/notes-pressed.png"))
        """
        if self.notes == None:
