...
class Note(BasicFunc):
    def __init__(self,widget):
        ...
        self.buttonGroup.addButton(self.cancel)
        ...
        self.upload.setStyleSheet("background-color: black; font-size:" + str(int(btnDim*0.2)) + "px;")
        ...
        self.fuel.setStyleSheet("background-color: black; font-size:" + fontSize + "px;")
        self.textLayout.addWidget(self.fuel, 0,0)
        self.lineGroup.append(self.fuel)

        self.cost = QLineEdit(self.textWidget)
        self.cost.setFixedSize(textWidth,textHeight)
        self.cost.setStyleSheet("background-color: black; font-size:" + fontSize + "px;")
        self.textLayout.addWidget(self.cost, 1,0)
        ...
        self.kilometers.setStyleSheet("background-color: black; font-size:" + fontSize + "px;")
        self.textLayout.addWidget(self.kilometers, 2,0)
        ...
        self.textLayout.addWidget(self.kilometersLabel,2,1)
